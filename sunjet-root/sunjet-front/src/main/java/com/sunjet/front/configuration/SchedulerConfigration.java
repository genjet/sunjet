...
public class SchedulerConfigration {
	...
	// return
	// JobBuilder.newJob(CalendarJob.class).withIdentity("CalendarJob").storeDurably()
	// .build();
	// }
	//
	// @Bean
	// public Trigger calendarJobTrigger() {
	// CronScheduleBuilder cronSchedulerBuilder =
	// CronScheduleBuilder.cronSchedule(calendarJobTrigger);
